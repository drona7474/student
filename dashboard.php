	  ...
	  <!-- Left Sidebar End -->
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Good Morning,    <?php 
                $res = mysqli_query($link, "select * from admin where user='".$_SESSION['username']."'");
              ...
              ?>!</h4>
                                                <p class="text-muted mb-0">welcome message</p>
                                            </div>
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Circular</h4>
                                            ...
                                            <div class="card-body">
                                                <div class="table-responsive table-card">
                                                    <table
														...
														<?php	
										$sql="select * from Circular limit 5";
$run_query = mysqli_query($link,$sql);
		   ...
		   ?>   <tr>
                                                                <td>
                                                                    <h5 class="fs-14 my-1 fw-normal"><?php echo $title ?></h5>
